...
class GameMap:
    ...
    def set_resource(self, resource_type, new_value, player_id = 0):
        self.player_resources[player_id][resource_type] = new_value

    def subtract_resource(self, resource_type, amount, player_id = 0):
        ...
        self.set_resource(resource_type, held_resource - amount, player_id)
    ...
    def parse_state(self, state_line):
        ...
        self.create_parsed_units(p1units, 0)
        self.create_parsed_units(p2units, 1)

    def create_parsed_units(self, units, player_number):
